# AquaSim Architecture - Consolidated

---

## Source: Architecture_final.md
...
5. Yêu cầu Chức năng (Functional)
6. Yêu cầu Phi Chức năng (Non-Functional)
7. Thành phần (Components) & Services
...
## Architectural Sections from CHUC_NANG_CHI_TIET.md
...
## Database/Architecture Sections from THAY_DOI_VA_BO_SUNG.md
